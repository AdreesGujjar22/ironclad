          ...
          >
            ...
            <div className="pt-2 flex flex-wrap gap-3.5">
              <button
                ...
                className="px-6 py-3.5 bg-[#3B945E] hover:bg-[#318051] text-white font-bold text-xs uppercase font-mono tracking-wider transition-all shadow-md flex items-center justify-center gap-2 cursor-pointer border border-white/20"
              >
                <Calendar className="w-4 h-4 text-emerald-100" />
                <span>Book Site Survey in {location.name}</span>
              </button>
